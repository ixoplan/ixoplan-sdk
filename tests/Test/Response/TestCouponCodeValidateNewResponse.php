...
/**
 * Class TestCouponCodeValidateNewResponse
 *
 * @package Ixolit\Dislo\Test\Response
 */
class TestCouponCodeValidateNewResponse implements TestResponseInterface {
    ...
    /**
     * TestCouponCodeValidateNewResponse constructor.
     */
    public function __construct() {
        $this->couponCode = MockHelper::getFaker()->word;
        $this->event = CouponObject::COUPON_EVENT_START;
